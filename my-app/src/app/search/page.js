    ...
    return (
        <div className=" mx-auto">
            ...
            <div className="flex justify-center">
                ...
                />
                <label htmlFor="communities" className="mx-2">Communities</label>
                ...
                <input
                    ...
                    onChange={handleChange} // Handle change
                />
                <label htmlFor="users" className="mx-2">Users</label>
                ...
                <input
                    ...
                    onChange={handleChange} // Handle change
                />
                <label htmlFor="posts" className="mx-2">Posts</label>
            </div>
            {/* Add a Main Section */}
                ...
                <main className="w-full">
                    {
                        searchResults && searchResults[searchType].length > 0 ? (
                            searchResults[searchType].slice(0, 10).map((post) => {
                                ...
                                if (searchType === 'posts') {
                                    return (
                                        <a href={post.inAProfile ? `/${post.author}/posts/${post.id}` : `/community/${post.communityId}/posts/${post.id}`}>
                                            <article key={post.id} className="mb-4 bg-sky-950 rounded-lg p-4">
