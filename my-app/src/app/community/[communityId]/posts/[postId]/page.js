...
export default function Profile({ params }) {
    ...
    useEffect(() => {
        // Fetch data
        fetch(`http://localhost:9000/community/${communityId}/posts/${postId}`)
            .then((res) => res.json())
            .then((data) => {
                console.log(data)
                setPost(data.post || []);
    ...
    useEffect(() => {
        // Fetch data
        fetch(`http://localhost:9000/community/${communityId}`)
            .then((res) => res.json())
            .then((data) => {
                ...
                post ? (
                    <div className="flex flex-row justify-start bg-blue-200 rounded-lg p-4 mx-56">
                        <div className="w-full">
                            ...
                            <p className="text-sm text-gray-500 mb-4">Posted by {post.owner}</p>
